...
! are documented in:
!
! Cai, Wang, and Luo, J. Chem. Comp. Theo. In Press, 2009.
!
...
! Xiang, Wang, and Luo, J. Chem. Phys. Submited. 2009.
!
! The dielectric models and molecular surfaces used in the electrostatic 
! solvation model are documented in:
!
! Wang, Ye, and Luo, J. Phys. Chem. Submitted, 2009.
! Ye and Luo, J. Phys. Chem. Submitted, 2009.
!
...
! hydrophobic or repulsive), in this implementation. The dispersion term
! is computed by a numerical integration over the solvent accessible surface
! area. The cavity term is modeled by a term proportional to the molecular
! surface or volume with a single proportional constant. See the following
