...
subroutine init_array(xs,epsx,epsy,epsz,p_iv,p_bv, &
   ...
   _REAL_ epsx(1:xmymzm), epsy(1:xmymzm), epsz(1:xmymzm)
   ...
   case (1)
      ...
      am2(1:xmym) = epsout
      am3(1:xmym) = epsout
      am1(xmym+1:xmym+xmymzm) = epsx(1:xmymzm)
      am2(xmym+1:xmym+xmymzm) = epsy(1:xmymzm)
      am3(xmym+1:xmym+xmymzm) = epsz(1:xmymzm)
      call pb_initad( am1,am2,am3,ad(1),ad1(1) )
      am1(1:xmym) = ZERO
      am2(1:xmym) = ZERO
      am3(1:xmym) = ZERO
   ...
   case (2)
      ...
      am2(1:lxmym) = epsout
      am3(1:lxmym) = epsout
      am1(lxmym+1:lxmym+xmymzm) = epsx(1:xmymzm)
      am2(lxmym+1:lxmym+xmymzm) = epsy(1:xmymzm)
      am3(lxmym+1:lxmym+xmymzm) = epsz(1:xmymzm)
      call pb_initad( am1,am2,am3,ad(1),ad1(1) )
      ...
      lepsx(1:xmymzm) = epsx(1:xmymzm)
      lepsy(1:xmymzm) = epsy(1:xmymzm)
      lepsz(1:xmymzm) = epsz(1:xmymzm)
      lfactor = factor1
...
!=====================================================================================================================
subroutine pb_initad( am1,am2,am3,ad,ad1 )

   _REAL_ am1(1-xmym:xmymzm), am2(1-xmym:xmymzm), am3(1-xmym:xmymzm)
   _REAL_ ad(1:xmymzm), ad1(1:xmymzm)

   integer l

   do l = 1, xmymzm
      ad1(l) = am1(l-1) + am1(l) + am2(l-xm) + am2(l) + am3(l-xmym) + am3(l)
   end do
   ad(1:xmymzm) = factor1*iv(1:xmymzm) + ad1(1:xmymzm)
...
!        call timer_stop(TIME_MGRLX)

!        call timer_start(TIME_MGRES)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      if ( npbopt /= 0 ) then
      !if (itn == 1) call timer_start(TIME_SINH)
...
!        maxbf = maxval(abs(zv(1:xmymzm)))
      ...
      !if (itn == 1) call timer_stop(TIME_SINH)
      end if
...
subroutine pb_ionene(nfocus,level,savgox,savgoy,savgoz, &
   ...
   integer savxm(1:nfocus), savym(1:nfocus), savzm(1:nfocus)
   _REAL_ savgox(1:nfocus), savgoy(1:nfocus), savgoz(1:nfocus), savh(1:nfocus)
