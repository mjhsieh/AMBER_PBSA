...
void mjhsieh_(INT_T*,INT_T*,INT_T*,INT_T*,INT_T*,INT_T*,
	      INT_T*,REAL_T*,REAL_T*,REAL_T*,REAL_T*,REAL_T*,REAL_T*);
...
REAL_T epbsa(int ipb, REAL_T fillratio, PARMSTRUCT_T *prm, REAL_T *x, REAL_T *grad){
	int i, ifcap;
	ifcap = 0;
        REAL_T e_PBSA=0;
	REAL_T *f;
