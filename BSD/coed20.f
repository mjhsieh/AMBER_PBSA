...
subroutine coed20(maxirr,nq,index2,cirreg, &
   ...
   dimension w1(20, nqq), w4(20)
   dimension sd(21), uw(20,20), v(nqq, nqq)
   dimension ew(nqq)
   dimension ew1(nqq), ew2(nqq), ew3(nqq)
   dimension ew4(nqq), ew5(nqq), ew6(nqq)
   dimension ew7(nqq), ew8(nqq), ew9(nqq), ew10(nqq)
   dimension w31(nqq), w32(nqq), w33(nqq)
   dimension w34(nqq), w35(nqq), w36(nqq)
   dimension w37(nqq), w38(nqq), w39(nqq), w310(nqq)

   dimension sd2(20), work(1000)
...
subroutine coec20(ir, maxirr,nq,index2,cirreg, coe)
   implicit _REAL_ (a-h,o-z)
   parameter ( nqq = 27 )
